#RLExp_0110.py
from RL_opt_0110 import StateEncoder, PredictOptimizeVRP, AssignmentHandler, RewardCalculator, ActionExecutor
from RL_Agent_0110 import QLearningAgent
...
epochs = 500 # 設置訓練的 epoch 數量
csv_training_path = f'./Output/training/{epochs}epochs_nor.csv'
