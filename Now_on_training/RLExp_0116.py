#RLExp_0116.py
from RL_opt_0116 import StateEncoder, PredictOptimizeVRP, AssignmentHandler, RewardCalculator, ActionExecutor
from RL_Agent_0116 import QLearningAgent
...
assignment_handler = AssignmentHandler(distance_matrix)
...
vrp_model = PredictOptimizeVRP(
    ...
    device=device,
    csv_routes=f'./Output/baseline/baseline_routes_1.csv',
    csv_summary=f'./Output/baseline/baseline_summary_1.csv',
...
# 保存測試結果到 CSV
test_csv_filename = 'RLexp_test_results.csv'
